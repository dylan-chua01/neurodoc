        ...
        <section className="relative">
            <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <div className="flex justify-center items-center px-2 sm:px-5 lg:px-6 w-full">
                        {/* Summary Viewer - Add your content here */}
                        <div className="w-full max-w-4xl h-96 bg-gray-100 rounded-xl border border-gray-200">
                            {/* Placeholder for your PDF viewer/summary display */}
                        </div>
                    </div>
                </div>
            </div>
