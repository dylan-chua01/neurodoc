        ...
        <section className="relative mx-auto flex flex-col z-0 items-center justify-center py-16 sm:py-20 lg:pb-28 transition-all animate-in lg:px-12 max-w-7xl">
            <div className="flex flex-col items-center text-center w-full">
                ...
                <h2 className="text-lg sm:text-xl lg:text-2xl text-center px-4 lg:px-0 lg:max-w-4xl text-gray-600">
                    Get an accurate summary of your document in seconds
                </h2>
                ...
                <Button 
                    variant={'link'}
                    className="text-white mt-6 text-base sm:text-lg lg:text-xl rounded-full px-10 sm:px-12 lg:px-14 py-6 sm:py-7 lg:py-8 lg:mt-16 bg-gradient-to-r from-slate-900 to-rose-500 hover:from-rose-500 hover:to-slate-900 hover:no-underline font-bold shadow-lg transition-all duration-300 w-auto min-w-[220px] sm:min-w-[240px]">
                    <Link 
                        href="/#pricing"
                        className="flex gap-2 items-center justify-center w-full">
                        <span>Try NeuroDoc</span>
