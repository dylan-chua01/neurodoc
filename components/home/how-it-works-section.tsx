...
const steps: Step[] = [
    {
        ...
        description: 'Simply drag and dropyour PDF document or click to upload'
    },
    {
    ...
    return (
        <section className="relative overflow-hidden bg-gray-50">
            <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                <div
                    aria-hidden="true"
                    className="pointer-events-none absolute inset-0 -z-10transform-gpu overflow-hidden blur-3xl">
                <div 
                    className="relative left-[calc(50%-3rem)] aspect-1155/678 w-[36.125] -translate-x-1/2 bg-linear-to-br from-emerald-500 via-teal-500 to-cyan-500
